...
def CategoryDetail(request,category):
    product = Product.objects.filter(category__title=category)
    return render(request,'Shop/category-details.html',{'product':product})
...
class PaymentView1(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, "Shop/payment1.html", context)
